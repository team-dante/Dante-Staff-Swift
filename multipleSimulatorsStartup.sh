...
path=$(find ~/Library/Developer/Xcode/DerivedData/Dante\ Staff-*/Build/Products/Debug-iphonesimulator -name "Dante Staff.app" | head -n 1)
echo "${path}"
...
xcrun simctl launch "$line" com.dante-staff # Launch .app using its bundle at simulator with identifier hold by $line var
done